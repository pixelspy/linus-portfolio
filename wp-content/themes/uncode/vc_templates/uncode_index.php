		...
		<div class="<?php echo esc_attr(trim(implode(' ', $parent_container_classes))); ?>">
			...
			if ( $posts_counter > 0 ):
				...
				foreach ( $posts as $key_post => $post ):
					...
					if ( isset($typeLayout['media']) && isset($typeLayout['media'][6]) && $typeLayout['media'][6] === 'hide-atc') {
